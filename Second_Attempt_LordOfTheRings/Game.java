package Second_Attempt_LordOfTheRings;
...
public class Game {
    ...
    public static void printCommand(String title) {
        System.out.println(title);
        printSepettor();
    }

    public static void printSepettor() {
        for (int i = 0; i < 30; i++) {
            System.out.print("=");
        }
        System.out.println();
    ...
    public void startGame() {
        ...
        do {
            showMenu();
            printCommand("Enter your decision!");
//            System.out.println("Enter your decision!");
    ...
    public void describeWeapon() {
        //I must add if the hero doesn 't select weapon yet.
        currentWeapon.setWeapon("Knife");
...
//        System.out.println();
    ...
    public void describeVillain() {
        //    I must add if there is no enemy appeared
...
//                currentLocation.addWeaponToPlace(currentWeapon.);
                System.out.println();
            }
        } else {
...
//                there is a problem also I must add a statement if grabbed first item when it put down double 2 nd weapon
