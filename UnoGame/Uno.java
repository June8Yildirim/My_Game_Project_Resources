...
//        reviveDeck();
    ...
    private boolean isValidChoice(Player p,int choice) {
         ...
         * to be a valid choice: the player must have the card, the card must be either the same color or
         * value as the current card(card in play/previously played card)
         */
